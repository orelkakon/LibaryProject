...
public abstract class MicroService implements Runnable {
    ...
    private HashMap<Class<?>, Callback<Object>> callBackForMessage = new HashMap <Class<?>, Callback<Object>>();
    private MessageBus mB = MessageBusImpl.getInstance();

    /**
     * @param name the micro-service name (used mainly for debugging purposes -
     *             does not have to be unique)9
     */
	...
	protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        callBackForMessage.put(type, (Callback<Object>) callback);  
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try{
            	Message mess = mB.awaitMessage(this);
            	callBackForMessage.get(mess.getClass()).call(mess);;
